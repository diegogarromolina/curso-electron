class Marcadores {
    constructor() {
        ...
        this.formulario = document.querySelector('.creacion-marcador-formulario')
    ...
    agregarEventListeners() {
        ...
        this.formulario.addEventListener('submit', this.crearMarcador.bind(this))
    }
    ...
    visualizarMarcadores() {
        ...
        let html =  marcadores.map(value => this.generarHtmlMarcador(value)).join('')
